<%@ Page Title="" Language="C#" MasterPageFile="~/MasterGUI/Menu.Master" AutoEventWireup="true" CodeBehind="ModoPago.aspx.cs" Inherits="MedicinalFinal.GUI.ModoPago"EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class=" container">
        <!--Primera fila-->
        <div class="Row">
            <h1 class="h1">Gestionamiento de modos de pago</h1>
        </div>
        <br />
        <br />
        <!--Segunda fila-->
        <div class="Row">
            <!--Primera columna-->
             ...
             <div class=" Col-md-3 card  " style="width: 30%; position:absolute ">
               <h5 class="card-header">Modos de pagos</h5>
              <div class="card-body">
                <div class="form-group">

                    <div class="input-group">
                       <div class="input-group-prepend">
                        <span class="input-group-text">ID de pago</span>
                       </div>
                    ...
                    <div class="input-group">
                       <div class="input-group-prepend">
                        <span class="input-group-text">Nombre del pago</span>
                       </div>
           ...
           <div class=" Col-md-3 card" style="right:-600px; width:40%" >
                <h5 class="card-header">Lista de Modos de pagos</h5>
               <div class="card-body">
                  <asp:GridView ID="gnv_pago" runat="server" OnRowDataBound="gnv_pago_RowDataBound" OnSelectedIndexChanged="gnv_pago_SelectedIndexChanged"></asp:GridView>
               </div>
          </div>  
        </div>
    </div>
